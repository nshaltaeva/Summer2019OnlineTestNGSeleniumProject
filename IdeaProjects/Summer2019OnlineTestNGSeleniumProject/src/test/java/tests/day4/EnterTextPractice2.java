...
4. Verify that message "Your e-mail's been sent!" is displayed
    ...
    public static void main(String[] args) {
        ...
        //Keys.ENTER will simulate ENTER button
        input.sendKeys("random@email.com", Keys.ENTER);
        WebElement confurmationMessage = driver.findElement(By.name("confirmation_message"));
        String expectedMessage = "Your e-mail's been sent!";
        //to get the text from element
        String actualMessage = confurmationMessage.getText();
